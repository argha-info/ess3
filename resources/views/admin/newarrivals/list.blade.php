        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card-header">
              ...
              <a href="{{ route('admin.newarrivals.create') }}" class="float-right btn btn-info add_role">Add {{ $title ?? '' }}</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  <script>
    $(document).ready(function(){
        ...
        var table = $('.datatable').DataTable({
            ...
            ajax: "{{ route('newarrivals-all-data') }}",
            columns: [
        ...
        $('body').on('click','.delete',function(){
          ...
          function(){
            $.ajax({
                type:'POST',
                url: "{{route('admin.newarrivals-delete')}}",
                async:false,
