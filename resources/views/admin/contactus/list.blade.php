        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card-header">
              ...
              <a href="{{ route('admin.contactus.create') }}" class="float-right btn btn-info add_role">Add {{ $title ?? '' }}</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  <script>
    $(document).ready(function(){
        ...
        var table = $('.datatable').DataTable({
            ...
            ajax: "{{ route('contactus-all-data') }}",
            columns: [
                {data: 'location', name: 'location'},
                {data: 'email', name: 'email'},
                {data: 'company_phone', name: 'company_phone'},
                {data: 'support_phone', name: 'support_phone'},
                ...
                {data: 'youtube_link', name: 'linkedin_link'},
