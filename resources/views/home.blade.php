      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row no-gutters">
          <div class="col-lg-6">
            ...
            @if ($banner->status ==1)
            @if($homeabout->homeabout !='' && file_exists(public_path('uploads/homeabout/'.$homeabout->homeabout)))
...
<section class="new-arrival" data-aos="fade-up">
    ...
    <div class="arrival-right">
        @if($newarrivals->newarrivals !='' && file_exists(public_path('uploads/newarrivals/'.$newarrivals->newarrivals)))
