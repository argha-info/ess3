        ...
        <ul>
          <li><a class="nav-link scrollto active" href="{{url('/')}}">Home</a></li>
		   <li class="dropdown"><a href="#"><span>Category</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{url('/product_list')}}">Leggings</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>About Us</h3>
            <p>Lorem ipsum dolor sit amete, consectetur adipisicing sed do eiusmod tempor icididunt ut labore etel dolore magna aliqua. enim adminim veniam, done quisnostrud exercitation ullommodo.
            </p>
...
INDIA</p>
 <p><img src="{{asset('front/assets/img/ic-2.png')}}" alt="Ic" ><a href="tel:06291579939"> 062915 79939</a></p>
 <p><img src="{{asset('front/assets/img/ic-3.png')}}" alt="Ic" ><a href="mailto:emailaddress@domain.com"> emailaddress@domain.com</a></p>
 <p><img src="{{asset('front/assets/img/ic-4.png')}}" alt="Ic" ><a href="https://ess3.co.in"> ess3.co.in</a></p>
